...
List<Article> articleFromJson(List<int> str) => List<Article>.from(
    json.decode(utf8.decode(str)).map((x) => Article.fromJson(x)));
...
class Links {
  ...
  factory Links.fromJson(Map<String, dynamic> json) => Links(
        ...
        wpFeaturedmedia: List<Author>.from((json["wp:featuredmedia"] ??
                [
                  {"embeddable": true, "href": ""}
                ])
            .map((x) => Author.fromJson(x))),
